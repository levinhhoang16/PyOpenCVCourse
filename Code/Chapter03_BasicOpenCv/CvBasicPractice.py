...
# Ve hinh tron tam (700,500), ban kinh 40,  B G R
cv2.circle(image, (700,500),40, (0,0,255))


# Ve duong cheo hcn
cv2.line(image, (608,196), (821,687), (255,0,0), 5)


# Ghi chu bat dau vi tri (100,100), font size 1 do day 3
cv2.putText(image, "Open CV text", (100,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 5)
